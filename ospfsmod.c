...
static void logEntry(char *str)
{
#if DEBUG_FS
  eprintk("LOG: Entered function: %s()\n", str);
#endif
}
...
{
  logEntry("create_blank_direntry");
	// Outline:
